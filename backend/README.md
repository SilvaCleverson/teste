...
Puedes navegar a este directorio desde el directorio superior usando:
```sh
cd backend
```

Y puedes navegar a cualquiera de los tutoriales de la misma forma, por ejemplo:
```sh
cd 00_intro
```
